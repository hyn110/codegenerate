package com.anj.generator.service.impl;
...
import com.anj.common.config.Global;
import com.anj.common.constant.Constants;
import com.anj.common.utils.StringUtils;
import com.anj.generator.domain.ColumnInfo;
import com.anj.generator.domain.TableInfo;
import com.anj.generator.mapper.GenMapper;
import com.anj.generator.service.IGenService;
import com.anj.generator.util.GenUtils;
import com.anj.generator.util.VelocityInitializer;
    ...
    public void generatorCode(TableInfo table, List<ColumnInfo> columns, ZipOutputStream zip)
    {
        ...
        for (String template : templates)
        {
            ...
            try
            {
                ...
                log.info("====代码生成器 fileName = {}",fileName);
