...
public class MysqlGenerator extends GeneratorTest {
    ...
    public static final String DB_URL = "jdbc:mysql://127.0.0.1:3306/civro?useUnicode=true&allowPublicKeyRetrieval=true&useSSL=false&characterEncoding=utf8" ;
     ...
     * 表名生成策略
     */
    private static NamingStrategy sUnderline_to_camel= NamingStrategy.underline_to_camel;
    /**
     * 实体类的公有字段
     */
    ...
    public static void main(String[] args) {
        ...
        AutoGenerator mpg = new AutoGenerator().setGlobalConfig(
            ...
            new StrategyConfig()
                    ...
                    .setNaming(sUnderline_to_camel)// 表名生成策略
            ...
            new InjectionConfig() {
                ...
                public String outputFile(TableInfo tableInfo) {
                    return "../com/mapper/" + tableInfo.getEntityName() + ".xml";
                }
            }))
        ).setTemplate(
